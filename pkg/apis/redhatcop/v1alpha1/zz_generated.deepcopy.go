...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtraCaCert) DeepCopyInto(out *ExtraCaCert) {
	*out = *in
	if in.Keys != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtraCaCert.
func (in *ExtraCaCert) DeepCopy() *ExtraCaCert {
	if in == nil {
		return nil
	}
	out := new(ExtraCaCert)
...
func (in *Quay) DeepCopyInto(out *Quay) {
	*out = *in
	...
	in.Resources.DeepCopyInto(&out.Resources)
	if in.ExtraCaCerts != nil {
		in, out := &in.ExtraCaCerts, &out.ExtraCaCerts
		*out = make([]ExtraCaCert, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
